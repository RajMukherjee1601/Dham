  ...
  return (
    <div className="contact-page">
      <header className="top-bar">
        <div>
          <h2 className="page-title">Bhairavidham Travel</h2>
        </div>
      </header>
      ...
      <section className="event-section">
        <div className="event-container">
          <h3 className="event-title">Karthika Somavara Travel</h3>
          ...
          {/* Example videos for this event */}
          <h4 className="event-subheading">Event Videos</h4>
          <div className="video-scroll">
            <button
              className="media-item"
              onClick={() => openMedia("video", "/videos/travel1.mp4")}
            >
              <video className="media-video" muted>
                <source src="/videos/travel1.mp4" type="video/mp4" />
              </video>
            </button>
          </div>
        </div>
      ...
      <section className="event-section">
        <div className="event-container">
          <h3 className="event-title">Karthika Somavara Travel (2)</h3>
          <p className="event-description">
            Another beautiful journey with devotees, darshan, and pooja.
          </p>
      ...
      <section className="event-section">
        <div className="event-container">
          ...
          <h3 className="event-title">Kamakhya Yatra (2024)</h3>
          <p className="event-description">
